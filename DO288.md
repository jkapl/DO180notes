...
Minimize the number of layers. The RUN, COPY and ADD instruction create layers. Use the && separator to execute multiple commands within one RUN instruction
